class DeleteCommentUseCase {
  ...
  async execute(useCasePayload) {
    ...
    await this._threadRepository.existsThread(thread);
    await this._commentRepository.existsComment(comment);
    await this._commentRepository.isOwner(comment, owner);
